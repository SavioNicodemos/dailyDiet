...
const Home = () => {
  ...
  function handleViewMeal(id: string | undefined) {
    ...
    return Alert.alert(
      i18n.t("pages.home.meal"),
      i18n.t("pages.home.noValidId")
    );
  }
  ...
  return (
    <Container>
      ...
      >
        ...
        <PercentageText
          percentageValue={percentageOnDiet}
          style={{ marginTop: -20 }}
        />
      </MealsPercentageContainer>

      <MealListContainer>
        <MealTitle>{i18n.t("pages.home.meals")}</MealTitle>
        ...
        {isLoading ? (
          ...
          <SectionList
            ...
            ListEmptyComponent={
              <ListEmpty message={i18n.t("pages.home.noAddedMeals")} />
            }
            contentContainerStyle={
              mealsBySection.length === 0 ? { flex: 1 } : { paddingBottom: 50 }
            }
